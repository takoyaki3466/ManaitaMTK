...
import com.takoy3466.ManaitaMTK.block.menu.MTKFurnaceMenu;
...
public class MTKFurnaceBlockEntity {
    public static class FurnaceEntityWood extends MTKFurnaceBlockEntityBase {
    ...
    public static class FurnaceEntityStone extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityIron extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityGold extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityDiamond extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityMTK extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityGODMTK extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
    ...
    public static class FurnaceEntityBreak extends MTKFurnaceBlockEntityBase {
        private final MTKEnum mtkEnum;
