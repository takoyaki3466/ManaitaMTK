...
public class ScreenOpenTrigger extends SimpleCriterionTrigger<ScreenOpenTrigger.TriggerInstance> {
    public static final ResourceLocation ID = new ResourceLocation(ManaitaMTK.MOD_ID, "mtk_open");
    public static final String PATH = "screen";

    public ScreenOpenTrigger() {
    }
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(ContextAwarePredicate contextAwarePredicate, String screenId) {
            super(ScreenOpenTrigger.ID, contextAwarePredicate);
